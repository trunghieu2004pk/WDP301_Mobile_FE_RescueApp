...
import {
  ...
  ScrollView, StatusBar, Dimensions, Modal,
} from 'react-native';
                  ...
                  {inProgressRequests.length > 0 && (
                    <View style={styles.badge}>
                      <Text style={styles.badgeText}>
                        {inProgressRequests.length > 99 ? '99+' : String(inProgressRequests.length)}
                      </Text>
                    </View>
                  )}
                </TouchableOpacity>

                {/* Logout — FIX: removed empty <Text> child */}
          ...
          <View style={styles.sosRow}>
            <View style={{ flex: 1 }}>
              <View style={styles.sosBadge}>
                {/* FIX: plain string literal, no template literal */}
                <Text style={styles.sosBadgeText}>{'KHẨN CẤP'}</Text>
              </View>
              {/* FIX: replaced template literal with explicit newline string */}
